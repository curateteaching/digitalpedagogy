...
*Source URL: [http://chineseenglishmen.adelinekoh.org/](http://chineseenglishmen.adelinekoh.org/)
*Artifact Permissions: 
*Creator and Affiliation: Adeline Koh (Stockton University)

An early-stage project, Digitizing Chinese Englishmen is a project to digitize and archive the Straits Chinese Magazine, a journal published by diasporic Chinese in Southeast Asia at the turn of the 20th century. The project offers glimpses into colonial Southeast Asia through primary texts. These texts, though limited at the moment, are valuable resources for teaching about gender as it relates to colonialism, imperialism, and race, as the “Victorian Chinesemen” at the heart of the publication present a complex portrait of masculinity and precarious power in Imperial Britain. The decolonial imperative of the project can be used to train students in comparative analysis in courses on British Empire. Students can gain valuable experience in digitizing, markup, critical annotation and digital project maintenance. Director of the project, Koh suggests using the archive's texts to update traditional close reading assignments: "get students to do a close reading on one of the journal pieces studying victorian forms of masculinity, like a victim of chap ji ki (gambling)--the point of the story is that gambling leads to insanity and death." This  exercise builds on skills students are already learning in their class, but it broadens the canon and thus allows students to interrogate the production of gender and race within the British Empire. 

KDH: WHILE ALL OF THESE ARCHIVES ARE IMPORTANT AS SITES OF MATERIALS, WE’RE REALLY LOOKING FOR THE PEDAGOGICAL MATERIAL. IN SOME OF YOUR ARTIFACTS, YOU MAKE A RECOMMENDATION ABOUT HOW TO USE IT AS AN ASSIGNMENT, BUT WE REALLY NEED THAT ASSIGNMENT RATHER THAN A FEW LINES WITH A SUGGESTION. IT HELPS THOSE WHO WILL READ THROUGH THIS KEYWORD IF THEY CAN DOWNLOAD AND RE-MIX ASSIGNMENTS IMMEDIATELY (SOMETIMES WITH GRADING RUBRICS OR FURTHER INSTRUCTIONS). FOR ANY THAT YOU HAVE INCLUDED HERE WITH THE SUGGESTED ASSIGNMENT, CAN YOU FIND AN ACTUAL ASSIGNMENT THAT SOMEONE HAS WRITTEN UP? THE IMPORTANT ASPECT OF THIS ARTIFACTS IS THE PEDAGOGICAL INSTRUCTIONS RATHER THAN THE INSPIRATION FOR CLASS DISCUSSION/READINGS.


###"Regender”
*Artifact Type: Web tool
*Screenshot “Regender.png”
*Source URL: [http://regender.com/](http://regender.com/)
*Artifact Permissions: Copyright Ka-Ping Yee, 2005
*Creator and Affiliation, Ka-Ping Yee

Regender is a web-based tool designed to perform what the developer calls a “gender hack” on existing websites. Specifically, it highlights the use of gender pronouns in  English-language sites by switching those pronouns. This is a simple tool for revealing bias, and for opening up space to unpack gender binaries. Additionally, Regender exposes what Jill Walker Rettberg calls “technological filters” (tools that allow people to control their self-expression online) and “cultural filters” (“norms, expectations, normative discursive strategies” that influence behavior) that shapes daily life online. This tool reveals how code can be used to challenge built-in assumptions of the web and the cultural values expressed in web content. Regender is not perfect and can be buggy, but its flaws (difficulty in determining gender in some cases) also make it good example for discussions of algocentrism. A low-key exercise that can be done with the tool is to ask students to search for a specific person (e.g. Hillary Clinton or Beyonce) and then have them explain the search results that are returned with the subject's gender reversed or "hacked.” Students can then be asked to write a paper or reflect in a blog entry about the hidden gender bias that is made visible through the tool. 


###"Fat, Ugly or Slutty"
*Artifact Type: Website, blog
*Screenshot: “FatUglyorSlutty.png”
*Source URL: [http://fatuglyorslutty.com/](http://fatuglyorslutty.com/)
...
KDH: HERE TOO IN THIS SUB-SECTION; WE NEED THOSE ASSIGNMENTS TO HELP OUR READERS GET INTO TEACHING YOUR KEYWORD

###"Situated Knowledges Map"
*Artifact Type: In-class Activity
*Screenshot: “FTNMap.png”
...
*Screenshot: “FTNwikistorming.png”
...
KDH: THIS IS A GREAT COLLECTION! HOWEVER, RATHER THAN SENDING READERS TO A MASS OF MATERIAL, CAN YOU CHOOSE 1 TO HIGHLIGHT FOR THIS ARTIFACT AND THEN SEND THEM TO THE BIG ARCHIVE WITHIN THE ARTIFACT RATIONALE? 

##Semester-long Feminist Pedagogical Experiments

###"FemTechNet DOCC: Dialogues on Feminism and Technology"
*Artifact Type: Syllabus
*Screenshot: “FemTechNetDOCC.png”
...
*Screenshot: “sociological_images.png”
