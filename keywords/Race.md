...
the academy. I locates this work in activist politics, in new modes of crowdfunding, and
...
academy to the public. I’ve used the following criteria in selecting these artifacts: 
...
The hashtag can be taught in conjunction with themes of the appropriation of work by women of color in feminist movements and in relation to hashtag activism and new social media feminist movements and in comparison to their pre-internet counterparts.
...
The tumblr blog would be good as an assigned reading in digital humanities classes, particularly in relation to considering the relationship of its content to the field at large. For example, students could do a comparison of some of the publications to the tumblr in comparison with other digital humanities publications (e.g. *Debates in the Digital Humanities*, *Digital Humanities Quarterly*), to discuss what overlap there is between research topics.
...
Instructors who are teaching more racially and ethnically classes can also help add to the project by contributing to the [WikiProject African Diaspora](https://en.wikipedia.org/wiki/Wikipedia:WikiProject_African_diaspora) Educators who want to get started with teaching with Wikipedia can look at [my blog post on resources on getting started](http://www.adelinekoh.org/blog/2015/03/05/resources-on-integrating-wikipedia-into-your-classroom/), and contact the [Wiki Education Foundation](http://wikiedu.org/), an organization that has been developed especially to give classroom support for education. 
