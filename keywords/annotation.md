...
Fortunately, they're now available in abundance. As a result, they're also helping readers practice a kind of intimacy much harder to achieve on paper: intercourse with large numbers of other readers, who can exchange ideas in the margins of a text though vastly separated from one another in space. 

Two words that frequently appear in conjunction with tools for online annotation are "open" and "social." [Open Utopia](http://theopenutopia.org), Stephen Duncombe's annotatable edition of Thomas More's _Utopia_, is "open to criticism, open to participation, and open to re-creation" by its readers thanks to a platform named [SocialBook](http://www.livemargin.com). SocialBook's CEO, Bob Stein, is founder and co-director of the [Institute for the Future of the Book](http://futureofthebook.org), the birthplace of [MediaCommons](http://mediacommons.futureofthebook.org/), a "digital scholarly network" where in 2009 Kathleen Fitzpatrick made her manuscript [*Planned Obsolescence*](http://mcpress.media-commons.org/plannedobsolescence/) available for ["open peer review"](http://mcpress.media-commons.org/plannedobsolescence/#pAisatbctchwtsOotptahainrprfdaiwbamphtaepiciospwpao) using [CommentPress](http://futureofthebook.org/commentpress/), an annotation plugin to the open-source blogging platform [WordPress](http://wordpress.org).

The rhetoric here is of a piece with the promise of radical democracy: free expression, common ownership, mutual commitment; liberty, equality, fraternity. It stands in marked opposition to those aspects of higher education pedagogy and scholarship that remain, even in democratic societies, hierarchical, exclusive, proprietary, and competitive.
...
## CURATED ARTIFACTS
*Arranged alphabetically by annotation platform*

### ARTIFACT 1

#### METADATA

- **Title:** A.nnotate: Image Annotation Assignment
- **Type:** Assignment
* ![screenshot](images/annotation_image_annotation.png)
- **Source URL:** http://web.uvic.ca/~englblog/pedagogydhsi/files/2012/05/baer.pdf
...
- **Title:** Genius: Guidelines for Annotating Fiction
- **Type:** Best Practice
* ![screenshot](images/annotation_genius_fiction.png)
- **Source URL:** http://genius.com/Meera-nair-annotation-exercises-for-fiction-boot-camp-annotated
- **Permissions:** None specified
...
- **Title:** Google Docs: Annotation Assignment
- **Type:** Assignment
* ![screenshot](images/annotation_google_docs.png)
- **Source URL:** http://diglibarts.whittier.edu/?page_id=1372
- **Permissions:** Used with permission of author
...
- **Title:** Hypothes.is: Teacher Resource Guide
- **Type:** Resource Guide
* ![screenshot](images/annotation_hypothesis_resource_guide.png)
- **Source URL:** https://hypothes.is/teacher-resource-guide/
- **Permissions:** None specified
...
- **Title:** Mozilla PopcornMaker: Video Annotation Assignment
- **Type:** Assignment
* ![screenshot](images/annotation_video_annotation.png)
- **Source URL:** http://files.cargocollective.com/18691/TVAnalysisPopcornMaker.pdf
