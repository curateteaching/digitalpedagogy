...
The artifacts assembled here begin with assignments and exemplars for spatially oriented multimodal texts, followed by assignments and exemplars for temporally oriented ones. Even as the lines between remix videos and webtexts are increasingly blurry as, for instance, video can be incorporated into websites and platforms such as Scalar, while annotations and hyperlinks can be placed in video.

The resources below begin with assignments and exemplars for spatially oriented multimodal texts, followed by assignments and exemplars for temporally oriented ones. Even as the lines between remix videos and webtexts are increasingly blurry as, for instance, video can be incorporated into websites and authoring platforms such as Scalar. The final two items operate at the meta-level providing an archive of sorts, one that includes rubrics, student reflections and published multimodal work by undergraduates.
...
Having taught video remix since 2008, I have seen a wide range of student work, which tends to be either conceptually sound or technically solid, but seldom both. Indeed, when students are learning a new technology, it can be difficult to keep the type of critical consciousness they have when composing with with verbal language. But even for those who have mastered the technology, it takes a great deal of finesse to construct a multimodal argument that is [complex and nuanced](http://journal.transformativeworks.org/index.php/twc/article/view/358/279) in the space of a 5-10 minute video. *Where the Buffalo Roam* is the exception to this rule, demonstrating the contradictions of U.S. military efforts in liberating Nazi camps, while also practicing racism in its treatment of its own troops. By stipping out the images for most of this piece, the video’s formal sever the conceptual ends as the absence of regard for black soldiers is highlighted. 
