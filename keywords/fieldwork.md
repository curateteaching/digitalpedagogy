...
Fieldwork has always been central to pedagogy in many scholarly disciplines. Archaeological digs, geographical surveys, and ethnographic interviews readily come to mind, but the proliferation of international general education and study abroad programs has also introduced new disciplines to fieldwork. Fieldwork as a pedagogical practice has two central components: learning by doing through an immersive encounter with research in action, and learning by traveling and dwelling in a spatially-demarcated field. We think that digital culture, and the new methods and tools it introduces, are transforming the practice of fieldwork, for scholars and students alike. 

> JENTERY: This is a perfect introduction to fieldwork for readers of the collection. Thank you! Throughout the curatorial statement, feel free to also add parenthetical references to related research and further reading. One aim of the collection is to build bibliography. (One other question I have here is how the practice of fieldwork transforms or shapes digital culture, but I'll read on to see whether the relationship is unidirectional.) 
...
> JENTERY: Thank you. The emphasis on empirical methodologies is especially interesting here, in part because such methodologies are underrepresented in our collection. For now, my primary question is what might change if you reduced references to novelty (e.g., "new expressive forms of fieldwork practice and pedagogy"). Without relying much on "new," is there a way to be slightly more concrete about the implications of digital pedagogy for fieldwork? 

In adopting pedagogical practices that promote creativity and enable experimentation, the digital artifacts we gather also expand the limits of what counts as knowledge production in the humanities. Students script, direct, and shoot videos that demonstrate their engagement with community groups as well as their exploration of critical ideas relevant to a particular field. The emphasis remains on development over product as a necessary part of the learning process. As fieldwork shifts to the web and goes live more readily at earlier stages of collection and analysis, it is modeled for students as interactive, iterative, and ultimately as inquiry and discovery. This philosophy of making or building as a way of knowing leverages the digital in the artifacts we have assembled, finding shape in critical reconstructions of field sites, media-making, and project-driven fieldwork. 

> JENTERY: I appreciate the emphasis on process here, and this paragraph in particular overlaps in compelling ways with a number of our keywords, including "Video." At some point in this statement, how do you feel about discussing or differentiating between "documentation" and "expression" in fieldwork? I ask because it seems like video could serve both purposes (evidence and commentary). Also, in the final sentence of this paragraph, you stress how a philosophy may shape or "leverage" digital materials. Perhaps this point is something to consider when reviewing the previous two paragraphs (especially the first one), which tend to stress how digital technologies change culture?  

As a pedagogical research practice, fieldwork already has a collaborative ethos, but our artifacts show how digital fieldwork is rescaling these collaborations. Drawing on citizen science and wikipedia movements to engage communities from all over the world in the collection of data and the production of knowledge, these artifacts attempt to engage a wide and varied public to participate in data gathering and commentary. As the scale of data collection is unprecedented, so too is the role of researcher democratized. New social configurations also emerge around these artifacts, whether a loosely connected network of citizen fieldworkers, a devoted network of Pinterest or social-media followers, or supportive kinship networks commenting on student fieldwork. The hierarchical roles of teacher and student, and researcher and subject are being reconfigured through more open and networked models of fieldwork collaboration.

> JENTERY: I like how you provide example configurations in this paragraph. I also follow the impulses of radical change, but some readers may wonder whether changes in scale are necessarily linked to democratization. For instance, could such shifts enable exploitation (e.g., through digital labour, online harassment, and contingent positions/work)? While such exploitation is probably beyond the scope of your argument, perhaps the language here could be more open to its existence, or more open to concerns about network configurations and data expansion? Also, how do you feel about "wikipedia movements"? I ask because I'm not sure everyone will follow it (e.g., whether it's linked specifically to Wikipedia, to wikis in general, or to something else). Also, in the second sentence, perhaps the second use of "engage" could be revised, given its appearance earlier in the same sentence? 

Finally, the digital fieldwork represented by our artifacts involve a critical rethinking of site-specific inquiry. Fieldwork has traditionally been invested in attention to place as a source of meaning and knowledge: a researcher (or group of researchers) travels to a site and returns with data for analysis. Digital fieldwork can, however, break down the perceived distance between field and home. It can do so through the virtual reconstruction of an archeological site, which collapses the distinction between there and here, then and now, opening students to an immersive experience in a three-dimensional world. Data collection can be accelerated through simple and widely accessible mobile tools such as smart phones. Perhaps even more important, results can be shared and disseminated almost immediately. With digital mediation, information and expressive content can travel more quickly from home to field and back again, and the boundaries between them can become more porous. At the same time, site sensitivity remains with awareness that digitization of fieldwork sites and artifacts can distort. 

> JENTERY: I like how immersion pops up several times in this chapter. To me, it expands the very definition (or maybe just the scope?) of fieldwork to include screen-based interfaces and remote research. Is that fair? If so, then in terms of pedagogy readers might wonder how, if at all, immersion changes across site-specific work and screen-based work (both now types of "fieldwork"?). Or perhaps the two become entangled beyond any neat demarcation? I appreciate your example of data collection (and its acceleration) as an example in this instance. I also appreciate your attention to the combination of porous boundaries with site sensitivity (immersion plus critical distance?). All that said, readers might find distinctions between types of immersion (e.g., screen and off-screen) informative, even if those distinctions are brief/pithy. I ask because I imagine some are curious whether/how too much attention to technologies (e.g., staring at phones instead of attending to surroundings) may inhibit fieldwork in some way. These issues touch on your last artifact, which underscores how (or whether) technology affords distance, including a distance from colonial methods and legacies.
...
> JENTERY: Thank you. I like how you move from project description to use in the classroom.
...
> JENTERY: This is great. Thank you, especially for the second half of the paragraph, which gives readers a concrete sense of how this artifact might apply to their own pedagogy and teaching. 
...
Developing an efficient data collection system during intensive fieldwork is challenging. Notes scribbled on paper and mistyped on devices are illegible or confusing, while photographs and videos quickly fill up cell phone storage. As data accumulates across platforms, it demands metadata to remain meaningful for inquiry and retrieval. This blog, produced by The Social Media Research Collective, proposes Pinterest as a solution: an easy-to-use, web-based tool for archiving, annotating, and sharing digital image artifacts collected during fieldwork. Available as a mobile app, Pinterest integrates the process of data capture and storage. It is linkable to social media feeds for immediate sharing and presentation. As a digital image archive of fieldwork artifacts gathered on the go, it also allows for ongoing review of fieldwork observations and practices. In clear language and via links to Pinterest boards used for fieldwork, this blog post lays out the potential value of this digital platform in fieldwork.

> JENTERY: Excellent. Thank you! One question here may be whether/how Pinterest affords privacy (or circulation within defined circles). Another question may be whether material posted to Pinterest is owned or somehow licensed by Pinterest (and maybe even where it's stored).
...
This is a trailer for a documentary titled, "A Journey Upstream: The Past and Presence of an 'Extinct' People," directed by archeology graduate student, Erica Kowsz, and part of SEARCH, a multi-institutional archaeology, cultural heritage, and linguistics project. The project aims to document the history and continued presence of the Sinixt Nation in British Columbia, despite it having been pronounced "extinct" in 1956 by the Canadian Government. As an example of digital fieldwork, the short video demonstrates the crucial role that technology brings to documentation, with interviews of the supposedly "extinct" members of Sinixt Nations. Although currently in the data collection stage, the video is an example of project staging, providing the public with some access to the historical context and aims of the project in advance of completion. The project also demonstrates how students use multimedia to create and disseminate archeological and anthropological research.

> JENTERY: Thank you! This artifact addresses some issues raised by the previous artifact. Some readers may wonder who will ultimately manage or own these videos (e.g., the Sinixt Nation? a university? the students? a government?). Also, readers may be curious how fieldwork and documentation define who is the researcher and who is the research subject. Do digital technologies influence these relationships and negotiations? 
...
> JENTERY: Thank you! Would you be willing to add a sentence or two about how this video or approach may be used in fieldwork courses? Or about how either could inform the development of fieldwork courses and their instruction? 
...
The 2013 Cultural Heritage Informatics Fieldschool website has everything instructors need for thinking about how fieldwork can happen locally in the digital age. Students build digital skills related to the field of cultural heritage, concentrating on visualizing cultural data and undertaking data-intensive fieldwork on a range of sites. In conceptualizing fieldwork as a critical practice of "building as a way of knowing" rather than as a spatial practice of exotic displacement, the course (and the fieldschool entire) prioritizes the development of work over going out into the field. Instead of a team of student researchers leaving home for a six-week period at a foreign locale, the group comes together in an immersive and intensive work setting to engage in digital research around cultural heritage, using and aggregating existing data for projects on, for example, "Endangered African Heritage." The potential for cultural fieldwork to distance itself from its exoticist colonial legacies thus emerges with digitally-oriented research practices, described in depth on this course site through course objectives, assignments, schedules, projects, and resource lists.

> JENTERY: This is great. I especially appreciate how this artifact shifts the attention and location of fieldwork. Readers may wish to hear more about this gesture, near the end of your description: "The potential for cultural fieldwork to distance itself from its exoticist colonial legacies thus emerges with digitally-oriented research practices." How is this distance achieved, and in what relation to both colonialism and immersion? 
...
> JENTERY: In your statement, feel free to add parenthetical references to related research and further reading. Also, we're including references to all curated artifacts in the Works Cited section for each chapter. Thank you! 
