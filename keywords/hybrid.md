...
“Twitter vs. Zombies” is a game that aims at building networked communities, introducing new users to Twitter, and developing new media literacies. The initial rules were incredibly simple, a catalyst for play and improvisation. The outcomes were emergent with participants reflecting upon their learning in process on blogs, Storify, Twitter, and elsewhere. In February 2013, students in Pete Rorabaugh’s GSU class and Janine DeBaise’s SUNY class developed and ran the second iteration. Since then, students and teachers as far as Cairo, Egypt have forked and remixed the game. While this experiment happened on Twitter, the game represents a hybrid learning experience in that participants in later iterations were often co-located in a classroom while participating digitally, and also in that the game took place on a 24-hour clock, requiring players to join in using cell phones, tablets, as well as desktop computers. The game is interesting in how it demonstrates a hybrid teaching strategy asks educators and learners to think critically about the tools they use and how they can connect students to each other via the web.
