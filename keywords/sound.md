...
JENTERY: While I follow your claims for accessibility here (especially claims about accessible audio files), I do wonder if aspects of this paragraph (especially "once limited to professionals") ignore the cultures that congealed around ham radio, magnetic tape, and vinyl. Is there a way to mark what makes software distinct from these traditions, where large groups of amateurs also manipulated sound without formal training? In some ways, I wonder if it isn't arguable that, in the past (especially with tape), a significant portion of people produced their own amateur audio. Thoughts? 
...
JENTERY: This is also great. Would you be willing to either point to a specific recording in the library or to a prompt asking students to work with it?
...
JENTERY: I really like how you suggesting pairing "Speaking Back" with Open Sound New Orleans. Just echoing a previous remark, I wonder if some brief definitions (here or earlier) might be helpful. For instance, some readers may not know the difference between a soundscaping and sound mapping project, or if the two are treated synonymously. Elsewhere, sound studies practitioners may think of Murray Schafer's work here? Or work by Pauline Oliveros? 
