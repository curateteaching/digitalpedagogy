...
I work in virtual environments of all kinds, but physical co-presence remains--for now--my preferred classroom setting because it is rich with information.  On ground, our attention zooms across sense modalities.  Classroom learning is a full-body experience.  It's proprioceptive as our sense of self extends beyond our person to include our chairs and desks, the cluster of people we sit with, and the flows of ambient light and sound responding dynamically to our presence.  

KATHY: For these first two paragraphs (I've divided this one), the mix of pronouns between the you and our conflates the audience here; can you normalize or remove the pronouns in terms of audience/reader ownership? The sentences directly above become somewhat repetitive -- moving from virtual to physical in the description is interesting, but can you condense the last 3 sentences? 

Online, the pane of our attention shrinks to a manila envelope.  This is OK if what's inside the pane is constantly moving, as when we surf the Web, check our feeds, or make something.  But inside the virtual classroom, where so much of the screen is static unless the video flits between speakers and the chat bar whirls, there's little at the level of interface to hold our attention.  

KATHY: with the pronouns here even more pronounced is the flattening of roles: our represents both faculty and student together in the learning experience. Yes, they do both learn but they learn in various ways (rather than hierarchical ways). The metaphor of movement on screen gets obscured by the manila envelope imagery -- is the individual (dare I say "personal) screen the same as a virtual classroom? The online arena controlled by an individual seeking entertainment differs from the compulsory attendance of a synchronous virtual classroom, yes?

The user interface is crowded with elements that keep still; this is what a regular classroom may look like when students attend to the professor, but in reality attention is promiscuous.  Virtual classrooms are ocular-centric.  They fall short of recreating the multisensory dimensionality, the poly- and sub-vocal soundscapes of a classroom environment.  Haptics are well-developed for games, but not at all for virtual classrooms.  This is the case because virtual classroom software hasn't yet thought outside the conceptual frame of its medial antecedent, the physical classroom.  It's a little too faithful to a (boring) notion of classroom conduct.

KATHY: Well, can we say instead of boring "traditional" or some other descriptor? Our audience for this entire project might be those who are wedded to the physical classroom in neat rows. How can you convince them to venture out (beyond implicating that thing we hate, edutainment)? 

Just as in the early days of film, when a stationary camera recorded theatrical performance, so too in virtual classroom software, we're still waiting for design that plays to its unique medial strengths.  We're waiting for that "dolly" moment.

As more universities contract with third-party vendors to build online learning environments distributed at massive scale, the standard collegiate experience might become hybrid.  

KATHY: So, the next sentence calls forth DHers, but the audience for this project is definitely geared towards those who are not necessarily within the DH realm (and may eschew it for all kinds of reasons). Can you re-frame with an eye toward including those who are not DH?

As digital humanists, we should ask ourselves which aspects of our embodied classroom experience are fundamental?  When we talk about "liveness" in a classroom, are we really talking about "synchronicity"--shared, dynamic experiences of time?  Helen Burgess and Ryan Cordell, in separate projects featured here, created conditions where students physically enacted the procedural logics of Shakespearean sonnets (Burgess) and the material conditions of the scriptorium: the physically draining experience of "scrivening" by candlelight.  Could we do these projects in virtual classrooms?  Does it matter if we can't?  (I think it does.)

KATHY: The last 2 sentences above are very provocative. Can you answer them? Push this further to demonstrate why it's important.

My goal in curating this keyword is that every reader should find at least one project that makes her think: "I can do that!"  Finding projects that would excite such feeling in a broad range of learners was my challenge and my pleasure.  Other criteria included seeking projects written by and for nonwhite audiences; using creative writing pedagogy to analyze literary texts and analytical insight to enrich creative writing; and identifying best collaboration practices.  Two assignments deserve mention because they address particular audiences even as they also transcend them.  Jesse Stommel's "Twitter Essay" could be adapted into classrooms with heavy writing/grading cycles because the scale and duration of the Twitter Essay is entirely open.  Paul Fyfe's "How to Not Read a Victorian Novel" is printed in a closed access journal and therefore is not freely shareable.  But I found that Ryan Cordell had published on his website his adaptation of Fyfe's assignment, which seems to me even better: an opportunity to watch one practitioner "fork" an assignment, modify it to his setting and target audience.  The image I chose to illustrate Fyfe's essay is a Wordle on the theme of open access.  It is shared via a Creative Commons license.
...
* Screenshot: ![screenshot](images/interface Burgess-Sonnet.png)
...
* Screenshot: ![screenshot](images/interface Cordell-Scrivening.png)
...
* Name of Creators: Paul Fyfe; Ryan Cordell
* Attribution Information: Fyfe, Assistant Professor, North Carolina State University Department of English; Cordell, Assistant Professor, Northeastern University Department of English
...
* Name of Creator: Katherine D. Harris
* Attribution Information: Associate Professor, San Jose State University Department of English
...
* Name of Creator: Trent Hergenrader
* Attribution Information: Assistant Professor, Rochester Institute of Technology Department of English

Three aspects of <em>Steampunk Rochester</em> make it an exceptional digital pedagogy interface.  Blending history (1915-25), fiction, and speculative fiction, this genre-breaking/defining project is a roleplaying game layer precisely geolocated in settings in and around Rochester, NY.  
 
 KATHY: The above sentence is somewhat convoluted. Can you clarify?

Created in collaboration among four departments at R.I.T.--English, Fine Arts, Imagine Arts and Interactive Games--<em>Steampunk Rochester</em> will feed the local community with grade-A story even as it also turns the city into a game lab.  The large <em>Steampunk Rochester</em> wiki is already well populated with the people, places and things that will become the raw material for the interactive video game.  Trent Hergenrader's students, nimbly moving between play and creative writing, are engaging colleagues across the university in a highly applicative part of the creative digital humanities, where interdisciplinary projects make a "classroom" that's equal parts off-campus physical location, embodied imagination and game mechanic.  

* Screenshot: ![screenshot](images/interface MoEML-Ped-Partners-Jenstad.png)
* Source URL: https://www.facebook.com/permalink.php?story_fbid=10152947852203646&id=317355293645
* Name of Creator: Janelle Jenstad
* Attribution Information: Associate Professor, University of Victoria Department of English
...
* Screenshot: ![screenshot](images/interface Mongar-Esta-Vida.png)
* Source URL: http://estavidaboricua.com/
* Name of Creator: Sonja S. Mongar
* Attribution Information: Professor Emerita, Universidad de Puerto Rico de Mayagüez Department of English
...
KATHY: This is an interesting resource (above), but what are the specific teaching materials available? Can you pinpoint or highlight one aspect here? 

* Screenshot: ![screenshot](images/interface Twitter-bird-Stommel.jpg)
* Sour URL: http://www.hybridpedagogy.com/journal/the-twitter-essay/
* Name of Creator: Jesse Stommel: 
* Attribution Information: Assistant Professor, University of Wisconsin-Madison, Digital Humanities, English and Continuing Education
...
* Screenshot: ![screenshot](images/interface Wittig-1wknotech.png)
* Source URL: http://1wknotech.tumblr.com/
* Name of Creator: Rob Wittig; Mark C. Marino
* Attribution Information: Wittig, Assistant Professor at the University of Minnesota Duluth Department of Art and Design; Marino, Associate Professor of Writing (Teaching), University of Southern California
...
KATHY: Ah ha! Yes, in the above resource by Mark & Rob, you connect the 150-word statement back to interface. I think that's lacking for a lot of the 150-statements above. Would you be willing to go back and more sharply make that connection? You've defined interface in so many ways with these resources. Think about how someone would use each of these to define/re-define/disrupt that notion of interface. 
