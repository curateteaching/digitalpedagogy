...
When curating the keyword "Interface," I pursued the opposite of "deference."  I sought assignments in which interface "competes" with the output, drawing attention to its materiality and constructedness.  I sought to highlight the labor and mess of human/computer interaction, with the goal of prompting humanities students to examine interface from technical, material, and cultural perspectives. I believe study of interface is a contact point for nonhuman/human difference, an "in-betweenness,” as Homi Bhabha says of multiculturalism.  

A simple classroom exercise to think critically about interface is to have students make "autocomplete poetry."  Instruct students to type the same phrase into a commercial search bar, then each student screenshots the suggested autocompletions. (This works less well in [Duckduckgo] (https://duckduckgo.com/), which doesn't track query data.)  Students can use phones, laptops, lab computers--device doesn't matter.  What do the browser's autocomplete suggestions reveal about "popular" searches?  Can we find patterns in autocompletions of the same phrase on different machines?  Whose interest might be served by such returns?  

John Cayley and Daniel C. Howe's excellent work on Google data as our public commons in the arts-based [The Readers Project] (thereadersproject.org) interrogates who owns the information amassed by human activity in the world's largest public repositories, the volunteer labor that builds our public commons owned by corporations.  Eli Pariser’s influential **The Filter Bubble** (2011) became freshly and ominously relevant after disclosures of “fake news” during the 2016 U.S. presidential election revealed the extent to which enterprise interface customization comes at the cost of universally shared common information.

Building a webpage in HTML and CSS is a fundamental way to learn about interface, and there are several very good, free-to-use, browser-based resources I link to in Related Materials, below.  To move from being a consumer to a [code] (https://github.com/curateteaching/digitalpedagogy/blob/master/keywords/code.md) builder shifts students’ mindsets, giving a hands-on experience of how the open Web started as hand-coded webpages using [remix] (https://github.com/curateteaching/digitalpedagogy/blob/master/keywords/remix.md) and [play] (https://github.com/curateteaching/digitalpedagogy/blob/master/keywords/play.md), and tolerating [failure] (https://github.com/curateteaching/digitalpedagogy/blob/master/keywords/failure.md).

I curated ten Interface assignments to addresses a wide spectrum of student readiness and institutional support for digital humanities work. I sought to balance the number of male and female contributors, feature assignments designed for non-English speakers and non-English language learners, and meet the needs of beginning and advanced students.  Income-insecurity is not a barrier to learning about interface, as several of these assignments can be done using a cell phone.  I organize the ten assignments from technically easiest to hardest.  All of them are conceptually rigorous.
...
I remixed Benzon’s assignment using as my source texts T.S. Eliot’s *The Waste Land* and contemporary poet John Beer’s *The Waste Land and Other Poems.*  These we studied in various medial forms: paper, audio, Poetry Foundation website, Google images.  My students deformed the source texts into: 
•	an RPG game; 
...
## WORKS CITED
Apple Developer Human Interface Guidelines.  https://developer.apple.com/ios/human-interface-guidelines/overview/themes/

Austin, Brooke.  “Talking Orange.” http://brookeaustin.com/orange/ 2016.

Beer, John.  *The Waste Land and Other Poems.*  Canarium Books, 2010.

Berens, Kathi Inman.  “Introduction to Digital Humanities: Digital Literary Studies.”  https://mla.hcommons.org/deposits/item/hc:10305/
...
*Electronic Literature Collection Volume 3.*  Editors Stephanie Boluk, Leonardo Flores, Jacob Garbe and Anastasia Salter.  Cambridge, MA: The Electronic Literature Organization, 2016.

Fyfe, Paul. "How Not to Read a Victorian Novel." *Journal of Victorian Culture.* Vol. 16, No.1, April 2011, 84-88.

Gaard, Anders Gonzo.  “Take Gonzo.”  http://nickm.com/taroko_gorge/take_gonzo/ 2014.
...
Wilson, Peter. “What’s in a Tweet’s Metadata.” https://peterwilson.cc/a-tweets-metadata/  Posted August 6, 2014.  Accessed 22 September 2017.
